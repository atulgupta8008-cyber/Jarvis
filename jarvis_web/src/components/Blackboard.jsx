    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <button onClick={() => onMinimize(widget.id)} style={btnStyle} title="Minimize"><Minus size={14} /></button>
          <button onClick={() => onRemove(widget.id)} style={{...btnStyle, color: '#ff3366'}} title="Close"><X size={14} /></button>
        </div>
      </div>
